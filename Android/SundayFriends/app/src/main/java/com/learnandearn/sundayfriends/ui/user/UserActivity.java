...
public class UserActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setLanguageStrings(SharedPrefManager.getInstance(this).getLanguage());
    ...
    private void setLanguageStrings(String language){
        switch (language){
            ...
            case Constants.VALUE_SHARED_PREF_LANGUAGE_SPANISH:
                bottomNavigation.getMenu().getItem(0).setTitle(this.getString(R.string.home_spn));
                bottomNavigation.getMenu().getItem(1).setTitle(this.getString(R.string.my_family_spn));
                bottomNavigation.getMenu().getItem(2).setTitle(this.getString(R.string.my_profile_spn));

                break;

            case Constants.VALUE_SHARED_PREF_LANGUAGE_VIETNAMESE:
                bottomNavigation.getMenu().getItem(0).setTitle(this.getString(R.string.home_viet));
                bottomNavigation.getMenu().getItem(1).setTitle(this.getString(R.string.my_family_viet));
                bottomNavigation.getMenu().getItem(2).setTitle(this.getString(R.string.my_profile_viet));
                break;
        }
    }
