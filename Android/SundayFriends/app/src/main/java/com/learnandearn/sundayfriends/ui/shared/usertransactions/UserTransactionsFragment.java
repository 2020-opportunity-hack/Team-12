    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch (language){
            case Constants.VALUE_SHARED_PREF_LANGUAGE_ENGLISH:
                String title = context.getString(R.string.transaction_history_for_eng) + name;
                tvToolbarTitle.setText(title);
                break;

            case Constants.VALUE_SHARED_PREF_LANGUAGE_SPANISH:
                String titleSpn = context.getString(R.string.transaction_history_for_spn) + name;
                tvToolbarTitle.setText(titleSpn);
                break;

            case Constants.VALUE_SHARED_PREF_LANGUAGE_VIETNAMESE:
                String titleSpnViet = context.getString(R.string.transaction_history_for_viet) + name;
                tvToolbarTitle.setText(titleSpnViet);
