...
public class LinkFamilyFragment extends Fragment {

    private static final String TAG = "LinkFamilyFragment";
    ...
    private LinkFamilyViewModel    viewModel;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context = getContext();
        adapter = new SimpleListUsersAdapter(context, DialogType.LINK_FAMILY, listUsers);
        viewModel = new ViewModelProvider(this).get(LinkFamilyViewModel.class);
    ...
    private void setLinkFamilyListener() {
        viewModel.getUsersToLinkLiveData().observe(getViewLifecycleOwner(), new Observer<List<UserInfo>>() {
            @Override
