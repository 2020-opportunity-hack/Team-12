...
public class ActivateMenu extends PopupWindow {
    ...
    private int mUserId;
    public ActivateMenu(Context context, int userId) {
        super(context);
    ...
    private void setupView(){
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.popupmenu_activate, null);
    ...
    public void onSignOutBtnClick(){
        dismiss();
        adminActivity.activateUser(mUserId);
    }
